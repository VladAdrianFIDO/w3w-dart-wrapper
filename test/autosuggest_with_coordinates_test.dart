...
void main() {
  ...
  test('testWithCoordinates', () async {
    ...
    var autosuggest = await api.autosuggestWithCoordinates('index.home.ra', options: options).execute();
    ...
    for (var s in suggestions) {
      if (s.words == 'index.home.raft') {
        ...
        var autosuggestSelection =
            await api.autosuggestSelection('index.home.ra', 'text', s.words, s.rank, options: options).execute();
